...
!
!----------------------------------------------------------------------------
SUBROUTINE oldxml_potinit(starting)
  !----------------------------------------------------------------------------
  !
  ...
  RETURN
  !
END SUBROUTINE oldxml_potinit
!
!-------------
SUBROUTINE oldxml_nc_magnetization_from_lsda ( nnr, nspin, rho )
  !-------------
  !
  USE kinds,     ONLY: dp
  USE constants, ONLY: pi
  ...
  RETURN
  !
END SUBROUTINE oldxml_nc_magnetization_from_lsda
