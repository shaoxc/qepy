...
!----------------------------------------------------------------------------
SUBROUTINE pwpy_mix_rho( input_rhout, rhoin, alphamix, dr2, tr2_min, iter, n_iter,&
                    iunmix, conv )
  !----------------------------------------------------------------------------
  !
  ...
  CALL stop_clock( 'mix_rho' )
  !
  WRITE( stdout, *) 'mix values:', alphamix, dr2, tr2_min, iter, n_iter, tr2, ngm, ngms, ngm0
  RETURN
  !
END SUBROUTINE pwpy_mix_rho
!
!----------------------------------------------------------------------------
